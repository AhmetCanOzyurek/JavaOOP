...
public class C01_StringBuilder {
    public static void main(String[] args) {
        ...
        // non-pritimitce'ler ise icerdikleri  data miktarina bagli olarak hafizada yer isgal ederler

        // StringBuilder 3 farkli sekilde olusturulabilir

        StringBuilder sb1 = new StringBuilder();
        // icinde metin olmayan, 16 karakter olabilecek bir sb olusturur

        System.out.println(sb1.length());//0
        System.out.println(sb1.capacity());//16

        StringBuilder sb2 = new StringBuilder("Java");
        // 2- icinde "Java" lan, kapasitesi 16 + 4 = 20 karakter olan bir sb olusturur.
        ...
        // eger sb kapasitesi girdigimiz variable'ı kaldırmıyorsa java kapasiteyi iki ile çarpıp iki ekler.
